...
export default function HeroSection() {
  return (
    <div className="bg-[#9F98FF] min-h-screen px-6 flex justify-center items-center">
      <div className="max-w-[2000px] w-full flex flex-col lg:flex-row justify-around items-center gap-10">
        ...
        <div className="flex flex-col gap-10 items-start">
          ...
          <h3 className="text-xl text-white">Download HouseFlow for free today!</h3>
          <div className="flex flex-row gap-10">
            <a href="https://play.google.com/store/apps/details?id=com.houseflow" className="relative w-[160px] h-[50px]">
              <Image
                src={Google}
                alt="Google Play"
                fill
            ...
            <a href="https://apps.apple.com/us/app/houseflow-app/id6747577123" className="relative w-[160px] h-[50px]">
              <Image
                src={Apple}
                alt="App Store"
                fill
