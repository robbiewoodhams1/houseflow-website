        ...
        <div className="w-full max-w-xl p-8 bg-white rounded-2xl shadow-md md:mt-0 mt-20">
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            <div>
              <label
                htmlFor="name"
                className="block text-sm font-medium text-[#9F98FF]"
              >
                Name
              </label>
              <input
                ...
                id="name"
                name="name"
                className="mt-1 block w-full border border-gray-300 rounded-md p-3 focus:ring-[#9F98FF] focus:border-[#9F98FF] placeholder-gray-400 text-black"
            ...
            <div>
              ...
              <input
                ...
                id="email"
                name="email"
                className="mt-1 block w-full border border-gray-300 rounded-md p-3 focus:ring-[#9F98FF] focus:border-[#0F2C76 placeholder-gray-400 text-black]"
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-[#9F98FF] font-semibold py-3 rounded-full hover:bg-pink-900 transition disabled:opacity-50"
          >
